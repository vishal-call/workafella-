...
export const AppShell = ({ children }) => {
  ...
  return (
    <div className="h-screen w-screen flex bg-[#faf9f7] text-[#1a1c1b] overflow-hidden relative">
      ...
      <aside
        ...
        } fixed inset-y-0 left-0 z-50 md:relative md:z-30 h-screen max-h-screen bg-[#161616] text-[#ffffff] border-r border-[#27272a] transition-all duration-300 ease-in-out flex flex-col justify-between py-5 select-none flex-shrink-0 overflow-hidden shadow-2xl md:shadow-none`}
      >
        ...
        <div className="flex-shrink-0">
          ...
          <div className={`px-4 mb-5 flex items-center ${isSidebarOpen ? 'justify-between' : 'flex-col gap-3 justify-center'}`}>
            ...
            <button
              ...
              className="text-[#858383] hover:text-[#f5b400] p-1.5 rounded-xl hover:bg-[#27272a] transition-all flex items-center justify-center cursor-pointer"
      ...
      {/* Main Content Area */}
      <div className="flex-1 flex flex-col h-full bg-[#faf9f7]/90 dark:bg-[#0c0d0e]/90 backdrop-blur-xs overflow-hidden relative min-w-0">
        {/* Frosted Glass Top App Bar */}
        <header className="h-16 bg-[#faf9f7]/85 backdrop-blur-xl border-b border-[#e3e2e0] flex items-center justify-between px-3 sm:px-6 z-20 flex-shrink-0 sticky top-0">
          {/* Left: Mobile Menu Toggle & Live Centre Heartbeat */}
          <div className="flex items-center gap-2 sm:gap-4">
            <button
              ...
              className="p-1.5 md:hidden text-[#161616] dark:text-white hover:bg-[#f4f3f1] dark:hover:bg-[#27272a] rounded-xl flex items-center justify-center cursor-pointer transition-colors"
              title="Toggle Menu"
            >
